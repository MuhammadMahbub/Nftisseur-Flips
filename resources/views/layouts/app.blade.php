					...
					<ul class="navbar-nav navbar-nav--social text-center">
						...
						{{-- <li class="nav-item">
							<a class="dropdown-item" href="{{ route('locale', 'en') }}" data-language="en">
								<i class="bi bi-youtube">EN</i>
							</a>
						</li>
						<li class="nav-item">
							<a class="dropdown-item" href="{{ route('locale', 'fr') }}" data-language="fr">
								<i class="bi bi-youtube">FR</i>
							</a>
						</li> --}}
						<li class="nav-item">
							<a class="nav-icon" href="{{ socialurls()->youtube_url }}" target="_blank">
								<i class="bi bi-youtube"></i>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-icon" href="{{ socialurls()->instagram_url }}" target="_blank">
								<i class="bi bi-instagram"></i>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-icon" href="{{ socialurls()->twitter_url }}" target="_blank">
				...
				<div class="col-12">
					<ul class="footer--social nav justify-content-center">
						<li class="footer--social__item">
							<a class="footer--social__icon" href="{{ socialurls()->youtube_url }}" target="_blank">
								<i class="bi bi-youtube"></i>
							</a>
						</li>
						<li class="footer--social__item">
							<a class="footer--social__icon" href="{{ socialurls()->instagram_url }}v" target="_blank">
								<i class="bi bi-instagram"></i>
							</a>
						</li>
						<li class="footer--social__item">
							<a class="footer--social__icon" href="{{ socialurls()->fb_url }}" target="_blank">
								<i class="bi bi-facebook"></i>
							</a>
						</li>
						<li class="footer--social__item">
							<a class="footer--social__icon" href="{{ socialurls()->twitter_url }}" target="_blank">
								<i class="bi bi-twitter"></i>
							</a>
						</li>
					</ul>
					<p class="footer__copyright text-center"><a href="{{ generalsettings()->copyright_link }}" class="footer__copyright__link">{{ generalsettings()->copyright_name }}</a> Copyright 2022 © All rights Reserved.</p>
				</div>
			</div>
		</div>
	</footer>
