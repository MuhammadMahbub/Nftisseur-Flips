            ...
            <div class="card">
                <div class="card-header">
                    <div class="button-group-spacing w-100 text-right">
                        ...
                        <button class="btn btn-warning waves-effect w-sm-auto" data-toggle="modal" data-target="#imageCreate">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control table_search" id="search_convertimage" placeholder="Search Here">
                    ...
                    <div class="row" id="render_convertimage">

                        @include('admin.includes.convert.image_index')
...
<script>
    $(document).ready(function () {
        ...
        $('#filter__date').on('click',function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('date_wise_search_convertimage') }}",
                data: {
                    from_date: from_date,
                    to_date: to_date,
                },
                success: function(response) {
                    ...
                    if ((response.count)*1 <  1) {
                        $('#render_convertimage').html('<tr ><td colspan="1000" class="text-danger text-center py-3">No Data Found</td></tr>');
                    } else {
                        $('#render_convertimage').html(response.data);
                    }
        ...
        $("#clear__filter__date").on("click", function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('date_wise_clear_convertimage') }}",
        ...
        // search filter
        $('#search_convertimage').on('keyup',function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('search_wise_convertimage') }}",
                data: {
                ...
                success: function(response) {
                    console.log(response);
                    if ((response.count)*1 <  1) {
                        $('#render_convertimage').html('<tr ><td colspan="1000" class="text-center"><div class="alert alert-warning"><div class="alert-body">No Image Found</div></div></td></tr>');
                    } else {
                        $('#render_convertimage').html(response.data);
                    }
