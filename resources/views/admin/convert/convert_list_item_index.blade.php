            ...
            <div class="card">
                <div class="card-header">
                    <div class="button-group-spacing w-100 text-right">
                        ...
                        <button class="btn btn-warning waves-effect w-sm-auto" data-toggle="modal" data-target="#itemCreate">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control table_search" id="search_convertitem" placeholder="Search Here">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody id="render_convertitem">

                                @include('admin.includes.convert.item_index')
...
<script>
    $(document).ready(function () {
        ...
        $('#all_select_checkbox').change(function(){
            ...
            if($(this).is(":checked")){
                ...
                $("#delete_all").on('click', function(){
                    ...
                    $.ajax({
                        url: "{{ route('convert_list_multi_delete') }}",
                        type: 'POST',
                        data: {
                            ids: ids,
                        },
        ...
        $('.single_select_checkbox').change(function(){
            ...
            else
            {
                ...
                $('#export_all').val(ids);
                    ...
                    $.ajax({
                        url: "{{ route('convert_list_single_delete') }}",
                        type: 'POST',
                        data: {
                            ids: ids,
                        },
        ...
        $('#filter__date').on('click',function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('date_wise_search_convertitem') }}",
                data: {
                    from_date: from_date,
                    to_date: to_date,
                },
                success: function(response) {
                    ...
                    if ((response.count)*1 <  1) {
                        $('#render_convertitem').html('<tr ><td colspan="1000" class="text-danger text-center py-3">No Data Found</td></tr>');
                    } else {
        ...
        $("#clear__filter__date").on("click", function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('date_wise_clear_convertitem') }}",
        ...
        $('#search_convertitem').on('keyup',function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('search_wise_convertitem') }}",
                data: {
