            ...
            <div class="card">
                <div class="card-header">
                    <div class="button-group-spacing w-100 text-right">
                        ...
                        <button class="btn btn-warning waves-effect w-sm-auto" data-toggle="modal" data-target="#serviceCreate">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control table_search" id="search_service" placeholder="Search Here">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody id="render_service">

                                @include('admin.includes.service.index')
...
<script>
    $(document).ready(function () {
        ...
        @if($errors->has('title_edit'))
            $('#serviceEdit{{ session("service_id") }}').modal('show');
        @endif
        ...
        $('#all_select_checkbox').change(function(){
            ...
            if($(this).is(":checked")){
                ...
                $("#delete_all").on('click', function(){
                    ...
                    $.ajax({
                    url: "{{ route('service_multi_delete') }}",
                    type: 'POST',
                    data: {
                        ids: ids,
                    },
            ...
            else
            {
                ...
                $('#export_all').val(ids);
                    ...
                    $("#delete_all").on('click', function(){
                        ...
                        $.ajax({
                                url: "{{ route('service_single_delete') }}",
                                type: 'POST',
                                data: {
                                    ids: ids,
                                },
        ...
        $('#filter__date').on('click',function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('date_wise_search_service') }}",
                data: {
                    from_date: from_date,
                    to_date: to_date,
                },
                success: function(response) {
                    ...
                    if ((response.count)*1 <  1) {
                        $('#render_service').html('<tr ><td colspan="1000" class="text-danger text-center py-3">No Data Found</td></tr>');
                    } else {
                        $('#render_service').html(response.data);
                    }
        ...
        $("#clear__filter__date").on("click", function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('date_wise_clear_service') }}",
        ...
        $('#search_service').on('keyup',function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log(response);
                    if ((response.count)*1 <  1) {
                        $('#render_service').html('<tr ><td colspan="1000" class="text-center"><div class="alert alert-warning"><div class="alert-body">No Data Found</div></div></td></tr>');
                    } else {
                        $('#render_service').html(response.data);
                    }
